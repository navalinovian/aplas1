...
public class TestA1BasicUI052 extends ViewTest {
    ...
    private void checkCompletion() throws NullPointerException, ClassCastException {
        ...
        elements.add(android.support.v7.widget.AppCompatEditText.class); //Element 1
        elements.add(android.support.v7.widget.AppCompatSpinner.class);  //Element 2
        elements.add(android.support.v7.widget.AppCompatTextView.class); //Element 1
        elements.add(android.support.v7.widget.AppCompatEditText.class);  //Element 2
        elements.add(android.support.v7.widget.AppCompatSpinner.class); //Element 1
        /************************/
