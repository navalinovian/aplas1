...
public class TestA1BasicUI061 extends ViewTest {
    ...
    private void checkCompletion() throws NullPointerException, ClassCastException {
        ...
        elements.add(android.support.v7.widget.AppCompatCheckBox.class); //Element 1
        elements.add(android.support.v7.widget.AppCompatCheckBox.class);  //Element 2
        /************************/
