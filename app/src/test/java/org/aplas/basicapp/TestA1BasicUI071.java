...
public class TestA1BasicUI071 extends ViewTest {
    ...
    private void checkCompletion() throws NullPointerException, ClassCastException {
        ...
        elements.add(android.support.v7.widget.AppCompatRadioButton.class); //Element 1
        elements.add(android.support.v7.widget.AppCompatRadioButton.class); //Element 2
        elements.add(android.support.v7.widget.AppCompatRadioButton.class); //Element 3
        /************************/
